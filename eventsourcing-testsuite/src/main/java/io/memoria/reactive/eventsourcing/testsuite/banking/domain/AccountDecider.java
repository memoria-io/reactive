...
import io.memoria.reactive.eventsourcing.testsuite.banking.domain.event.ClosureRejected;
import io.memoria.reactive.eventsourcing.testsuite.banking.domain.event.CreditRejected;
